...
const AboutPage = () => {
  return (
    <div className="about-page">
      <div className="about-page__title">Палитра настроения</div>
      <div className="about-page__subtitle">помощник в определении оттенка состояния</div>
      <div className="about-page__section">
        <div className="about-page__section-title">Как пользоваться?</div>
      ...
      {/* <div className="about-page__section">
        <div className="about-page__section-title">Как это работает?</div>
        <p>
